...
docker-compose build --no-cache user-manager-service cloud-config
docker-compose build --no-cache api-gateway
#docker-compose build --no-cache user-manager-service

#docker-compose down task-manager-service project-manager-service user-manager-service cloud-config
#docker-compose up --build -d task-manager-service project-manager-service
#docker-compose up --build -d user-manager-service cloud-config
